...
export class PitchDetector {
    ...
    detect_pitch(input) {
        ...
        const ret = wasm.pitchdetector_detect_pitch(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    constructor(sample_rate) {
        const ret = wasm.pitchdetector_new(sample_rate);
        this.__wbg_ptr = ret;
...
const PitchDetectorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pitchdetector_free(ptr, 1));
